...
const TodoList = () => {
    ...
    const resultFilter = filterBy === 'all' ? resultSearch
        : filterBy === 'completed' ? resultSearch.filter(todo => todo.completed === true)
        : filterBy === 'notCompleted' ? resultSearch.filter(todo => todo.completed === false)
        : null
 // любое обновление
    // useEffect(() => {
